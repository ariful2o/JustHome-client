    ...
    return (
        <div className="flex flex-col lg:flex-row my-32 justify-evenly">
            <div className="max-w-2xl text-center">
                ...
                <h1 className="text-5xl text-[#43CEC6] font-bold my-10">SAY HELLO!</h1>
                <p className="text-3xl italic text-[#162C5A] mb-10">Make a difference in the life of a child with special needs, create an inclusive community and improve yourself!</p>
            ...
            <div className="text-center max-w-2xl shadow">
                ...
                <p className="text-[#A1A1A1] mb-10 mt-2">DONATED FOR KIDS WITH SPECIAL
                    NEEDS IN 2024</p>
                <p className="text-4xl text-[#162C5A] my-4 max-w-lg">Building meaningful, respectful relationships is the foundation for learning.</p>   
