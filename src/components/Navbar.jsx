    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-xl">Light House <span>SCHOOL</span></a>
            </div>
            ...
            <div className="navbar-end">
                ...
                <a className="btn mx-4 bg-[#FFD122]">DONATE</a>
                {
                    user?<a onClick={signout} className="btn mx-4">LOGOUT</a>: <Link to='/login' className="btn">LOGIN</Link>
                }
            </div>
        </div>
    )
