    ...
    return (
        <div className="flex flex-col lg:flex-row my-32 justify-evenly">
            <div className="max-w-2xl text-center">
                ...
                <p className="text-3xl italic text-[#162C5A] mb-10 font-sotify animate__animated animate__rollIn animate__delay-1s">Make a difference in the life of a Your with special needs, create an inclusive community and improve yourself!</p>
            ...
            <div className="text-center max-w-2xl shadow">
                ...
                <h1 className="text-4xl fonat-sotify font-bold text-[#43CEC6] my-4 animate__animated animate__rollIn">We Are Available <br /> For You 24/7</h1>
                <p className="text-[#A1A1A1] mb-10 mt-2 animate__lightSpeedInRight animate__animated animate__delay-2s">OUR ONLINE SUPPORT SERVICE IS ALWAYS 24 HOURS</p>
