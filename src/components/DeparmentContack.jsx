    ...
    return (
        <div className=" p-4 my-8 ">
            <div className="p-9 bg-[#192F59]">
                <h3 className="text-2xl text-white font-vibes animate__animated animate__backInDown animate__fast">Department Contact Info</h3>
                <p className="text-lg my-3 text-[#3DB166] animate__animated animate__backInDown animate__faster">Bachelor Of Science in Business<br />  Administration</p>
                ...
                <button className="btn btn-error rounded-3xl text-white my-8 animate__backInUp animate__animated animate-delay-2s">Student Resourrces</button>
            </div>
